...
const ProfilePage001_ = extend(Page)(
  //constructor
  function(_super, props) {
    ...
    profileHeader.children["imageviewmilon"] = (function() {
      const imageviewmilonStyle = getCombinedStyle(".imageView", {
        height: 120,
      ...
      var imageviewmilon = new ImageView(imageviewmilonStyle);

      return imageviewmilon;
    }).call(this);
    profileHeader.addChild(profileHeader.children["imageviewmilon"]);
...
module && (module.exports = ProfilePage001_);